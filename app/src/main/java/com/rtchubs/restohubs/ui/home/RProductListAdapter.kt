...
class RProductListAdapter(
    ...
    override fun createBinding(parent: ViewGroup): ProductItemBinding {
        return DataBindingUtil.inflate(
            ...
            R.layout.list_item_r_product, parent, false
        )
    }


    override fun bind(binding: ProductItemBinding, position: Int) {
