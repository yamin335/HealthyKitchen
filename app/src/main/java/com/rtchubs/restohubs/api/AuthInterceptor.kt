...
class AuthInterceptor(private val consumerKey: String, private val consumerSecret: String) : Interceptor {
    private var authSignature = ""
    ...
    fun getOauthParams(chain: Interceptor.Chain): ArrayList<NameValuePair> {
        ...
        authSignature = getOauth_signature(chain.request().method, request_url, consumerSecret, encodedParams)

        params.add(BasicNameValuePair("oauth_signature", authSignature))
